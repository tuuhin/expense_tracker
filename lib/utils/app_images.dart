...
Image authFailed({Color? color}) =>
    Image.asset('assets/flaticons/fail.png', color: color, scale: 2);
Image categoriesImage = Image.asset('assets/flaticons/category.png');

Image wallet(Color? color) =>
    Image.asset('assets/flaticons/wallet.png', color: color);
...
Image changePassword = Image.asset('assets/flaticons/key.png', scale: 3);
